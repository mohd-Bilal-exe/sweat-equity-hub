      ...
      <section className="bg-gray-50 px-4 sm:px-6 lg:px-8 py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mb-8 max-w-3xl text-gray-600 text-xl">
            We're revolutionising how people think about work by connecting talented individuals to
            leverage their skills for equity compensation. Because your contribution deserves more
            than just a paycheck.
          </p>
          <div className="flex sm:flex-row flex-col justify-center gap-4">
            <Button asChild size="lg">
              <Link to={createPageUrl('Home')}>Browse Equity Jobs</Link>
            </Button>
            <Button asChild variant="outline" size="lg">
              <Link to={createPageUrl('PostJob')}>Post Your Job</Link>
            </Button>
          </div>
        </div>
      </section>
              ...
              <div className="flex md:flex-row flex-col items-center gap-8">
                <div>
                  <h3 className="mb-3 font-semibold text-gray-900 text-2xl">
                    Our Solution: An Equity-First Job Board
                  </h3>
                  <p className="mb-4 text-gray-700 leading-relaxed">
                    sweatquity is the world's first job board exclusively focused on roles with
                    meaningful equity compensation. We believe that every employee should be able to
                    have equity in the companies they work for and share in the upside. By putting
                    equity front and center, we create a transparent marketplace where builders can
                    find opportunities to own a piece of what they create.
                  </p>
      ...
      <section className="bg-gray-100 px-4 sm:px-6 lg:px-8 py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mb-8 max-w-2xl text-gray-600 text-xl">
            Join thousands of talented individuals and innovative startups who believe in shared
            success.
          </p>
          <div className="flex sm:flex-row flex-col justify-center gap-4">
            <Button asChild size="lg">
